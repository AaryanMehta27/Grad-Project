...
sp_delta, _ = stats.spearmanr(merged['Exposure_Delta'], merged['AIOE'])

print(f"Correlation AIOE vs Anchored MAEI: {sp_anchored:.3f}")
print(f"Correlation AIOE vs Pure 2026 Base: {sp_pure:.3f}")
print(f"Correlation AIOE vs Hist F&O 2013: {sp_fo:.3f}")
print(f"Correlation AIOE vs EXPOSURE DELTA (The pure AI intervention!): {sp_delta:.3f}")
