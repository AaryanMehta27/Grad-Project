...
These are as follows: {\ttfamily flame.bst}, {\ttfamily flamedissertation.cls}, 
{\ttfamily flamedissertation.sty} and the folder {\ttfamily zz-imp}.

\section{Some useful packages}
Quite a few packages are loaded by {flamedissertation} which are very
...
the prematter. {\ttfamily flamedissertation} provides defaults for a simple glossary
...
prematter. {\ttfamily flamedissertation} provides defaults for a simple notations
